...
import com.yiyunnetwork.hwcollector.backend.GlobalConstants.abnormalIPMap
...
class HwCollectorBackendApplication

val applicationLogger by lazy { LoggerFactory.getLogger(HwCollectorBackendApplication::class.java) }
...
fun main(args: Array<String>) {
    ...
    runApplication<HwCollectorBackendApplication>(*args)
}
