package com.yiyunnetwork.fcollector.backend

import com.google.gson.Gson
import com.yiyunnetwork.fcollector.backend.GlobalConstants.abnormalIPMap
...
class FileCollectorBackendApplication

val applicationLogger by lazy { LoggerFactory.getLogger(FileCollectorBackendApplication::class.java) }
...
fun main(args: Array<String>) {
    ...
    runApplication<FileCollectorBackendApplication>(*args)
}
